...
func TestContainer(t *testing.T) {
	...
	t.Run("registering a service with invalid references fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `service *github.com/michalkurzeja/godi/v2/di_test.NoDepSvc is not registered but is referenced by factory of: *github.com/michalkurzeja/godi/v2/di_test.DepSvc`)
	})
	t.Run("registering a manual service without arguments fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `argument 0 of *github.com/michalkurzeja/godi/v2/di_test.DepSvc factory is not set`)
	})
	t.Run("registering a service with mistyped argument fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.DepSvc: argument int cannot be assigned to any of the function arguments`)
	})
	t.Run("registering a service with mistyped index argument fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.DepSvc: argument 1 must be assignable to string, got int`)
	})
	t.Run("registering a service with index-out-of-range argument fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.DepSvc: argument index out of range: 42`)
	})
	t.Run("registering a service with too many arguments fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.DepSvc: argument string cannot be assigned to any of the function arguments`)
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.DepSvc: argument int cannot be assigned to any of the function arguments`)
	})
	...
	t.Run("registering a factory with error returned first fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition: factory may only return an error as a second return value, not *github.com/michalkurzeja/godi/v2/di_test.NoDepSvc`)
	})
	...
	t.Run("registering a service with factory returning wrong type fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition: factory of *github.com/michalkurzeja/godi/v2/di_test.DepSvc must return a value assignable to *github.com/michalkurzeja/godi/v2/di_test.DepSvc as a first return value`)
	})
	t.Run("registering a service with a non-existing method fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.MethodDepSvc: no such method: NonExistingMethod`)
	})
	t.Run("registering a service with a method with wrong return value type fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.MethodDepSvc: method SetDepInvalid may only return an error, not int`)
	})
	t.Run("registering a service with a method with too many return values fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `invalid definition of *github.com/michalkurzeja/godi/v2/di_test.MethodDepSvc: method SetDepInvalid2 must return at most one value`)
	})
	t.Run("registering a circular dependency with factories fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `service *github.com/michalkurzeja/godi/v2/di_test.CircularDepCSvc has a circular dependency on *github.com/michalkurzeja/godi/v2/di_test.CircularDepASvc`)
	})
	...
	t.Run("registering an interface dependency with no implementations fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `service github.com/michalkurzeja/godi/v2/di_test.Fooer is not registered but is referenced by factory of: *github.com/michalkurzeja/godi/v2/di_test.IFaceDepSvc`)
	})
	t.Run("registering an interface dependency with multiple implementations fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `multiple implementations of di_test.Fooer found: [dep1 dep2]`)
	})
	t.Run("registering an interface dependency (method) with no implementations fails", func(t *testing.T) {
		...
		assertErrorInMultiError(t, err, `service github.com/michalkurzeja/godi/v2/di_test.Fooer is not registered but is referenced by: *github.com/michalkurzeja/godi/v2/di_test.IFaceMethodDepSvc.SetDep`)
	})
	...
	t.Run("getting a non-existent service fails", func(t *testing.T) {
		...
		assert.EqualError(t, err, `service *github.com/michalkurzeja/godi/v2/di_test.NoDepSvc not found`)
	})
	t.Run("getting a private service fails", func(t *testing.T) {
		...
		_, err = di.Get[*NoDepSvc](c)
		assert.EqualError(t, err, `service *github.com/michalkurzeja/godi/v2/di_test.NoDepSvc is private`)
	})
