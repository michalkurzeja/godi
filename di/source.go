...
// registered as a service is wrapped in a closure of godi's own - so those are
// left empty rather than pointing the reader into godi. So is a method value,
// whose wrapper the compiler writes and marks as generated.
