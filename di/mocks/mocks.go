...
// String provides a mock function for the type Arg
func (_mock *Arg) String() string {
	ret := _mock.Called()
...
func (_c *Arg_String_Call) Return(s string) *Arg_String_Call {
	_c.Call.Return(s)
	return _c
}
...
// Type provides a mock function for the type Arg
func (_mock *Arg) Type() reflect.Type {
	ret := _mock.Called()
...
func (_c *Arg_Type_Call) Return(typeParam reflect.Type) *Arg_Type_Call {
