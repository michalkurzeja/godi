...
func (_m *Container) Graph(cfg graph.Config) *graph.Graph {
	ret := _m.Called(cfg)
...
//   - cfg graph.Config
func (_e *Container_Expecter) Graph(cfg interface{}) *Container_Graph_Call {
...
func (_c *Container_Graph_Call) Return(_a0 *graph.Graph) *Container_Graph_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Container_Graph_Call) RunAndReturn(run func(graph.Config) *graph.Graph) *Container_Graph_Call {
	_c.Call.Return(run)
	return _c
}
