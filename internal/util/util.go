...
// func keyword is on.
//
// Both come back empty when there is nothing to point at: the value is not a
// function, the binary carries no line table for it, or the compiler wrote it,
// as it does for a method value.
