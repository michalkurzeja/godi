...
type Source interface {
	Graph(cfg Config) (*Graph, error)
}

// SourceFunc is a function used as a Source.
type SourceFunc func(cfg Config) (*Graph, error)

func (f SourceFunc) Graph(cfg Config) (*Graph, error) { return f(cfg) }
...
func Static(g *Graph) Source {
	return SourceFunc(func(Config) (*Graph, error) {
		if g == nil {
...
func Extract(src Source, opts ...Option) (*Graph, error) {
	...
	g, err := src.Graph(NewConfig(opts...))
	if err != nil {
		return nil, err
	}
	if g == nil {
