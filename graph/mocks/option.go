...
func (_m *Option) Execute(_a0 *graph.Config) {
	_m.Called(_a0)
}
...
func (_c *Option_Execute_Call) Run(run func(_a0 *graph.Config)) *Option_Execute_Call {
...
func (_c *Option_Execute_Call) RunAndReturn(run func(*graph.Config)) *Option_Execute_Call {
	_c.Run(run)
	return _c
}
